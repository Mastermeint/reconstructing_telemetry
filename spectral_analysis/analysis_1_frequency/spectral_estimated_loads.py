...
df = pd.read_csv('../Alliander_data/spectral_frequencies_cluster_profiles.csv')
connect_df = pd.read_csv('../Alliander_data/sorted_connect.csv')
meetdata_df = pd.read_csv('../Alliander_data/unique_meetdata.csv')
...
def estimated_load_cluster(df, number_cluster, meetdata_df):
    ...
    #meetdata_df.to_csv('../Alliander_data/trial.csv')
