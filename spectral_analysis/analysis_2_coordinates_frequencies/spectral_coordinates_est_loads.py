...
''' Now the data has been cleaned and we can start the spectral fit. '''
...
estimated_load_cluster_1 = estimated_load_cluster(df,0,meetdata_df)
...
plt.plot(customer_np[10000:11000], color='red', label = r"real load", alpha=0.8)
plt.plot(estimated_load_cluster_1[10000:11000], color='green', label = r"estimated load spectral", alpha=0.5)
plt.plot(np.sum(customer_np)*profile_np[10000:11000], color='blue', label = r"estimated load linear", alpha=0.3)
plt.legend()
plt.show()
'''
est_lin_load = np.sum(customer_np)*profile_np
...
ax1 = estimated_load_cluster_1.plot.line(color='red', grid=True,
                                label="estimated load spectral",
                                alpha=0.8)
ax2 = est_lin_load.plot.line(color='green', grid=True,
                            label="estimated load linear",
                            alpha=0.5)
ax3 = customer_np.plot.line(color='blue', grid=True,
                        label="real load",
                        alpha=0.3)
